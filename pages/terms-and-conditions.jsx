  ...
  return (
    <>
      <NextSeo
        ...
        description="Terms and Conditions for hrishikeshpathak.com"
      />
      <div className="max-w-screen-md mx-4 sm:mx-auto my-2 sm:my-6">
        ...
        <main className="py-4 sm:py-10">
          ...
          <h3 className="font-inter font-bold text-xl sm:text-2xl py-4 dark:text-white">
            Interpretation
          </h3>
          <p className="font-inter font-normal leading-loose text-base sm:leading-loose sm:text-xl  py-4 text-gray-800 dark:text-white">
          ...
          <ul className="list-disc list-inside py-4 dark:text-white">
            ...
            <li className="font-inter font-normal text-base sm:leading-loose sm:text-xl leading-loose dark:text-white py-4">
              <strong>Country</strong> refers to: Assam, India
            </li>
            <li className="font-inter font-normal text-base sm:leading-loose sm:text-xl leading-loose dark:text-white py-4">
              <strong>Company</strong> (referred to as either &quot;the
              Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot;
              in this Agreement) refers to Hrishikesh Pathak.
            </li>
            <li className="font-inter font-normal text-base sm:leading-loose sm:text-xl leading-loose dark:text-white py-4">
          ...
          <p className="font-inter font-normal leading-loose text-base sm:leading-loose sm:text-xl  py-4 text-gray-800 dark:text-white">
            ...
            <Link href="/about">
              <a
                ...
                target="_blank"
              >
                https://hrishikeshpathak.com/about
              </a>
            </Link>
          </p>
        </main>
